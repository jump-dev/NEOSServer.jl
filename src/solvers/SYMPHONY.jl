defNEOSSolver(:SYMPHONY, email=false, sos=false, duals=false)

function add_solver_xml!(::NEOSSYMPHONYSolver, m::NEOSMathProgModel)
	# Add user options
	param_string = ""
...
function parse_status!(::NEOSSYMPHONYSolver, m::NEOSMathProgModel)
...
function parse_objective!(::NEOSSYMPHONYSolver, m::NEOSMathProgModel)
